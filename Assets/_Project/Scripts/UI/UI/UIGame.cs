...
public class UIGame : UIBase
{
    ...
    public void OnClickCharacterSlot(int idx)
    {
        ...
        if (card != null && (card.isTargetSelect || 
            (card.rcode == "CAD00001" && UserInfo.myInfo.weapon != null && UserInfo.myInfo.weapon.rcode == "CAD00013" && UserInfo.myInfo.isShotPossible)))
        {
